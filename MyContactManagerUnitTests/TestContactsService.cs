...
namespace MyContactManagerUnitTests
{
    public class TestContactsService
  {
    ...
    private async Task<List<Contact>> GetContactsTestData()
    {
      return new List<Contact>() {
                new Contact() { Id = 5, Birthday = new DateTime(1937, 8, 12), City = "Birmingham", Email=EMAIL_5, FirstName = FIRST_NAME_5
                                ...
                                , StreetAddress1 = "555 Fifth St", StreetAddress2 = "BOX 55", UserId = USERID2, Zip="55555" },
                new Contact() { Id = 2, Birthday = new DateTime(1972, 11, 3), City = "Little Rock", Email=EMAIL_2, FirstName = FIRST_NAME_2
                                ...
                                , StreetAddress1 = "222 Second St", StreetAddress2 = "Apt 22", UserId = USERID2, Zip="22222" },
                new Contact() { Id = 1, Birthday = new DateTime(1947, 1, 1), City = "Los Angeles", Email=EMAIL_1, FirstName = FIRST_NAME_1
                                ...
                                , StreetAddress1 = "111 First St", StreetAddress2 = "Lot 11", UserId = USERID2, Zip="11111" },
    ...
    [Theory]
    [InlineData(FIRST_NAME_1, LAST_NAME_1, EMAIL_1, USERID2, 2)]
    [InlineData(FIRST_NAME_2, LAST_NAME_2, EMAIL_2, USERID2, 1)]
    [InlineData(FIRST_NAME_3, LAST_NAME_3, EMAIL_3, USERID2, 4)]
    [InlineData(FIRST_NAME_4, LAST_NAME_4, EMAIL_4, USERID2, 3)]
    [InlineData(FIRST_NAME_5, LAST_NAME_5, EMAIL_5, USERID2, 0)]
    ...
    {
      var contact = await _contactsService.GetAsync(45, USERID3);
